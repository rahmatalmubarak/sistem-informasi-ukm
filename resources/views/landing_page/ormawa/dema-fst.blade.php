...
<div class="row mt-3 mb-3">
    <div class="col-12 bg-dark d-flex justify-content-center align-items-center text-center w-full height-25" style="height: 130px;">
        <span class="text-bold" style="font-size: 30px">DEMA FST</span>
    </div>
    <div class="col-12 mt-3 px-5">
        ...
        <div class="text-center mt-5">
            ...
            <div class="text-left">
                <li>Menjadikan DEMA Fakultas Sains dan Teknologi UIN Imam Bonjol Padang sebagai mover teknologi dan wadah pergerakan mahasiswa dalam membangun kualitas mahasiswa yang berilmu, beragama dan progresif untuk menjadi imam dan menginspirasi semesta.</li>
