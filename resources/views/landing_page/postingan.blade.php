    ...
    <div class="col-12 d-flex justify-content-center mt-3">
        <div class="col-md-6">
            <div class="card mb-4 box-shadow">
                <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="{{Storage::url('public/img/data/'.$postingan->gambar)}}" data-holder-rendered="true">
            </div>
        </div>
    </div>
