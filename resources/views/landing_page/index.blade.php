                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top"
                            ...
                            src="{{Storage::url('public/img/data/'.$postingan->gambar)}}"
        ...
        <div class="col-12 d-flex bg-gray py-3">
            <div class="col-8">
                ...
                <div class="col-12 d-flex mt-3">
                    @foreach ($pengumuman_list as $pengumuman)    
                        <div class="col-6" style="max-width: 30%;">
            ...
            <div class="col-4 ml-1">
                ...
                <div class="col-12 d-flex mt-3 justify-content-center">
                    <div class="card card-widget shadow-sm" style="width: 80%">
                        <div class="card-footer p-0">
                            <ul class="nav flex-column">
                                {{-- @dd($agenda_list); --}}
                                @foreach ($agenda_list as $agenda)
                                    <li class="nav-item">
                                        <div class="nav-link d-flex align-items-center py-0" style="color: black">
                                            <div class="col-3 d-flex flex-column text-sm align-items-center">
                                                <span>{{\Carbon\Carbon::parse($agenda->tgl_post)->format('j')}}</span>
                                                <span>{{\Carbon\Carbon::parse($agenda->tgl_post)->format('F')}}</span>
                                            </div>
                                            <span class="col-9 ml-2"><a href="">{{substr($agenda->judul, 0, 30)}}</a></span>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
