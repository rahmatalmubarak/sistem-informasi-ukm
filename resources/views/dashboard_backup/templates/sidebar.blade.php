<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
            ...
            <span class="ms-1 font-weight-bold">Sistem Informasi Organisasi Mahasiswa</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (in_array(Auth::user()->role->nama, ['super admin', 'admin']))
                <li class="nav-item">
            ...
            @if (in_array(Auth::user()->role->nama, ['super admin']))
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('status_laporan.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            @endif
            @if (in_array(Auth::user()->role->nama, ['admin']))
                <li class="nav-item">
            ...
            @if (in_array(Auth::user()->role->nama, ['calon pendaftar']))
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('pendaftar.edit', ['id' => Auth::user()->id]) }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Ubah Data Diri</span>
                    </a>
                </li>
            @endif
        </ul>
