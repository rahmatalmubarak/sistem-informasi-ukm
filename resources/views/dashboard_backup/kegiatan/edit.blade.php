                ...
                <div class="card-body p-4 pt-0 pb-2">
                    <form method="POST" action="{{ route('kegiatan.update', $kegiatan->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('tgl_kegiatan') is-invalid @enderror" type="date" value="{{old('tgl_kegiatan', $kegiatan->tgl_kegiatan)}}"
                                name="tgl_kegiatan" id="tgl_kegiatan">
                        </div>
                        <div class="form-group">
                            <label for="deskripsi">Deskripsi</label>
                            <textarea class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi"
                                rows="3">{{old('deskripsi', $kegiatan->deskripsi)}} </textarea>
                        </div>
