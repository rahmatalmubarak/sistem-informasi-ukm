            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex">
                    ...
                    <div class="col-sm-4 d-flex">
                        ...
                        <div class="col-sm-6">
                            <a href="{{ route('user.create') }}" class="btn bg-gradient-primary">+ Tambah</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($user_list as $i => $user)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-xs font-weight-bold">{{$user->role->nama}}</span>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <li><a class="dropdown-item" href="{{ route('user.detail', ['id'=>$user->id]) }}">Detail</a></li>
                                                    <li><a class="dropdown-item" href="{{ route('user.edit', ['id'=>$user->id]) }}">Edit</a></li>
                                                    <li><form action="{{ route('user.delete', ['id'=>$user->id]) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
